...
public class SplashActivity extends BaseActivity{
    ...
    private void dealInit(){
        /*sqliteHelper.dropTable(ModelFactory.getLoginTableName());
        sqliteHelper.dropTable(ModelFactory.getUserTableName());*/
        // 判断默认头像是否存在，不存在则复制到SD卡
        File file = BitmapUtil.getImageFile(getApplicationContext(), LoveApplication.DEFAULT_AVATAR);
