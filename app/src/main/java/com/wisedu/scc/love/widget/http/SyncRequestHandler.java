...
public class SyncRequestHandler {
	...
	public static final String TAG = "SyncRequestHandler";
	...
	private String makeRequestWithRetries(HttpUriRequest request)
			throws IOException {
	...
	public String sendRequest(HttpUriRequest... params) {
		try {
